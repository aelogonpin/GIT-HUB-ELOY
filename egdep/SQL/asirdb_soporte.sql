...
CREATE TABLE `soporte` (
  `Fisico` varchar(2) DEFAULT NULL,
  `Digital` varchar(2) DEFAULT NULL,
  `Idsoporte` int NOT NULL,
  `Idconsola` int DEFAULT NULL,
  PRIMARY KEY (`Idsoporte`),
  KEY `Idconsola` (`Idconsola`),
  CONSTRAINT `soporte_ibfk_1` FOREIGN KEY (`Idconsola`) REFERENCES `consolas` (`Idconsola`),
  CONSTRAINT `soporte_chk_1` CHECK ((`Fisico` in (_utf8mb4'si',_utf8mb4'no'))),
  CONSTRAINT `soporte_chk_2` CHECK ((`Digital` in (_utf8mb4'si',_utf8mb4'no')))
