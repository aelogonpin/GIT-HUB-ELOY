...
CREATE TABLE `esports` (
  `Idesports` int NOT NULL,
  `Oficiales` varchar(25) DEFAULT NULL,
  `Solidarios` varchar(25) DEFAULT NULL,
  `Comunidad` varchar(25) DEFAULT NULL,
  PRIMARY KEY (`Idesports`)
